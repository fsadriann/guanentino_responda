    ...
    <nav class="nav">
     ...
     <main class="container-profile">
        <section class="section" id="profile">
         <div class="bar-chart" style="margin-top: 30%;">
         <div class="bar-ctn">
            <div class="bar mat">MA</div>
         </div>
         <div class="bar-ctn">
            <div class="bar cie">CS</div>
         </div>
         <div class="bar-ctn">
            <div class="bar soc">SP</div>
         </div>
         <div class="bar-ctn">
            <div class="bar ing">IN</div>
         </div>
         <div class="bar-ctn">
            <div class="bar esp">ES</div>
         </div>
         <hr class="hr2">
        </div>
        </section>
