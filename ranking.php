   ...
   <div class="side-navbar">
    ...
    <nav class="nav">
     ...
     <main class="container-rank">
        <section class="ranking" id="settings">
         <h2>Los primeros 10 mantienen
            su puesto la siguiente semana</h2>
         <table class="ranking-container-mini">
            <tr>
               <td class="td1">hola</td>
               <td class="td2">hola</td>
            </tr>
            <br>
         </table>
         <div class="ranking-container-2">
            <br> <h1>Hola</h1>
         </div>
        </section>
     </main>
